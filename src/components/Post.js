    ...
    return (
        <main className="bg-blue-50 min-h-screen p-12">
            <section className="container mx-auto">
                ...
                <h2 className="text-lg text-gray-600 flex justify-center mb-12">Welcome to my Little world</h2>
                        ...
                        <Link to={"/post/" + post.slug.current} key={post.slug.current}>
                            <span className="block h-64 relative rounded shadow leading-snug bg-white border-l-8 border-blue-400" key={index}>
                                ...
                                <span className="block relative h-full flex justify-end items-end pr-4 pb-4">
                                    <h3 className="text-gray-800 text-lg font-bold px-3 py-4 bg-blue-500 text-blue-100 bg-opacity-70 rounded">
                                        {post.title}
                                    </h3>
                                </span>
                            </span>
